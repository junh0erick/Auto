...
`ifdef WARP
`define CY_BLK_DIR "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_virtualmux_v1_0"
`include "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_virtualmux_v1_0\cy_virtualmux_v1_0.v"
`else
`define CY_BLK_DIR "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_virtualmux_v1_0"
`include "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_virtualmux_v1_0\cy_virtualmux_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\ZeroTerminal"
`include "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\ZeroTerminal\ZeroTerminal.v"
`else
`define CY_BLK_DIR "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\ZeroTerminal"
`include "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\ZeroTerminal\ZeroTerminal.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\OneTerminal"
`include "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\OneTerminal\OneTerminal.v"
`else
`define CY_BLK_DIR "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\OneTerminal"
`include "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\OneTerminal\OneTerminal.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_Counter_v3_0"
`include "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_Counter_v3_0\B_Counter_v3_0.v"
`else
`define CY_BLK_DIR "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_Counter_v3_0"
`include "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_Counter_v3_0\B_Counter_v3_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\bQuadDec_v3_0"
`include "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\bQuadDec_v3_0\bQuadDec_v3_0.v"
`else
`define CY_BLK_DIR "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\bQuadDec_v3_0"
`include "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\bQuadDec_v3_0\bQuadDec_v3_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\and_v1_0"
`include "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\and_v1_0\and_v1_0.v"
`else
`define CY_BLK_DIR "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\and_v1_0"
`include "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\and_v1_0\and_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_PWM_v3_30"
`include "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_PWM_v3_30\B_PWM_v3_30.v"
`else
`define CY_BLK_DIR "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_PWM_v3_30"
`include "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_PWM_v3_30\B_PWM_v3_30.v"
`endif

// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=0, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=1264, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=PWM_Motor, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_Motor, CY_INSTANCE_SHORT_NAME=PWM_Motor, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=PWM_Motor, )
module PWM_v3_30_4 (
    capture,
    clock,
    cmp_sel,
...
`ifdef WARP
`define CY_BLK_DIR "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_Timer_v2_80"
`include "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_Timer_v2_80\B_Timer_v2_80.v"
`else
`define CY_BLK_DIR "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_Timer_v2_80"
`include "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_Timer_v2_80\B_Timer_v2_80.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_tff_v1_0"
`include "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_tff_v1_0\cy_tff_v1_0.v"
`else
`define CY_BLK_DIR "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_tff_v1_0"
`include "D:\PSoc\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_tff_v1_0\cy_tff_v1_0.v"
`endif
...
module top ;
	...
	wire [0:0] tmpOE__quad_A_pendulo_net;
	wire [0:0] tmpIO_0__quad_A_pendulo_net;
	wire [0:0] tmpINTERRUPT_0__quad_A_pendulo_net;
	electrical [0:0] tmpSIOVREF__quad_A_pendulo_net;

	cy_psoc3_pins_v1_10
		#(.id("3b1009a4-327c-4b98-9779-c29da247c474"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		quad_A_pendulo
		 (.oe(tmpOE__quad_A_pendulo_net),
		  .y({1'b0}),
		  .fb({Net_13}),
		  .io({tmpIO_0__quad_A_pendulo_net[0:0]}),
		  .siovref(tmpSIOVREF__quad_A_pendulo_net),
		  .interrupt({tmpINTERRUPT_0__quad_A_pendulo_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__quad_A_pendulo_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__quad_B_pendulo_net;
	wire [0:0] tmpIO_0__quad_B_pendulo_net;
	wire [0:0] tmpINTERRUPT_0__quad_B_pendulo_net;
	electrical [0:0] tmpSIOVREF__quad_B_pendulo_net;

	cy_psoc3_pins_v1_10
		#(.id("01d8c360-9e43-49c5-b69a-25ff8ff55663"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		quad_B_pendulo
		 (.oe(tmpOE__quad_B_pendulo_net),
		  .y({1'b0}),
		  .fb({Net_14}),
		  .io({tmpIO_0__quad_B_pendulo_net[0:0]}),
		  .siovref(tmpSIOVREF__quad_B_pendulo_net),
		  .interrupt({tmpINTERRUPT_0__quad_B_pendulo_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__quad_B_pendulo_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__quad_A_motor_net;
	wire [0:0] tmpIO_0__quad_A_motor_net;
	wire [0:0] tmpINTERRUPT_0__quad_A_motor_net;
	electrical [0:0] tmpSIOVREF__quad_A_motor_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		quad_A_motor
		 (.oe(tmpOE__quad_A_motor_net),
		  .y({1'b0}),
		  .fb({Net_6766}),
		  .io({tmpIO_0__quad_A_motor_net[0:0]}),
		  .siovref(tmpSIOVREF__quad_A_motor_net),
		  .interrupt({tmpINTERRUPT_0__quad_A_motor_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__quad_A_motor_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__quad_B_motor_net;
	wire [0:0] tmpIO_0__quad_B_motor_net;
	wire [0:0] tmpINTERRUPT_0__quad_B_motor_net;
	electrical [0:0] tmpSIOVREF__quad_B_motor_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8c68b4c7-bcbb-4289-8f4c-dd959170d125"),
		  ...
		  .input_buffer_sel(2'b00))
		quad_B_motor
		 (.oe(tmpOE__quad_B_motor_net),
		  .y({1'b0}),
		  .fb({Net_10}),
		  .io({tmpIO_0__quad_B_motor_net[0:0]}),
		  .siovref(tmpSIOVREF__quad_B_motor_net),
		  .interrupt({tmpINTERRUPT_0__quad_B_motor_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__quad_B_motor_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_ENA_net;
	wire [0:0] tmpFB_0__Pin_ENA_net;
	wire [0:0] tmpIO_0__Pin_ENA_net;
	wire [0:0] tmpINTERRUPT_0__Pin_ENA_net;
	electrical [0:0] tmpSIOVREF__Pin_ENA_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_ENA
		 (.oe(tmpOE__Pin_ENA_net),
		  .y({Net_30}),
		  .fb({tmpFB_0__Pin_ENA_net[0:0]}),
		  .io({tmpIO_0__Pin_ENA_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_ENA_net),
		  .interrupt({tmpINTERRUPT_0__Pin_ENA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_ENA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    PWM_v3_30_4 PWM_Motor (
        .capture(1'b0),
        .clock(Net_5818),
        .cmp_sel(1'b0),
        .enable(1'b1),
	...
	cy_clock_v1_0
		#(.id("d8e3c27c-79c3-4fb3-804b-25f62de3de0c"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Pin_IN1_net;
	wire [0:0] tmpFB_0__Pin_IN1_net;
	wire [0:0] tmpIO_0__Pin_IN1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_IN1_net;
	electrical [0:0] tmpSIOVREF__Pin_IN1_net;

	cy_psoc3_pins_v1_10
		#(.id("d02d937d-7c61-4058-b8fa-f891024edbd0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_IN1
		 (.oe(tmpOE__Pin_IN1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_IN1_net[0:0]}),
		  .io({tmpIO_0__Pin_IN1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_IN1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_IN1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_IN1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_IN2_net;
	wire [0:0] tmpFB_0__Pin_IN2_net;
	wire [0:0] tmpIO_0__Pin_IN2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_IN2_net;
	electrical [0:0] tmpSIOVREF__Pin_IN2_net;

	cy_psoc3_pins_v1_10
		#(.id("ae88b0b4-675f-4600-8500-7429d087ed9c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_IN2
		 (.oe(tmpOE__Pin_IN2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_IN2_net[0:0]}),
		  .io({tmpIO_0__Pin_IN2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_IN2_net),
		  .interrupt({tmpINTERRUPT_0__Pin_IN2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_IN2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    UART_v2_50_5 UART_1 (
        ...
        .rx_clk(Net_334),
        .rx_data(Net_335),
        .rx_interrupt(Net_336),
        .tx(Net_337),
        .tx_clk(Net_338),
        .tx_data(Net_339),
        .tx_en(Net_340),
        .tx_interrupt(Net_341));
	...
	wire [0:0] tmpOE__tc_timer_net;
	wire [0:0] tmpFB_0__tc_timer_net;
	wire [0:0] tmpIO_0__tc_timer_net;
	wire [0:0] tmpINTERRUPT_0__tc_timer_net;
	electrical [0:0] tmpSIOVREF__tc_timer_net;

	cy_psoc3_pins_v1_10
		#(.id("eeacbad0-5b42-4676-8a31-83ecfeaf4a85"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		tc_timer
		 (.oe(tmpOE__tc_timer_net),
		  .y({Net_379}),
		  .fb({tmpFB_0__tc_timer_net[0:0]}),
		  .io({tmpIO_0__tc_timer_net[0:0]}),
		  .siovref(tmpSIOVREF__tc_timer_net),
		  .interrupt({tmpINTERRUPT_0__tc_timer_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__tc_timer_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pin_flag_net;
	wire [0:0] tmpFB_0__pin_flag_net;
	wire [0:0] tmpIO_0__pin_flag_net;
	wire [0:0] tmpINTERRUPT_0__pin_flag_net;
	electrical [0:0] tmpSIOVREF__pin_flag_net;

	cy_psoc3_pins_v1_10
		#(.id("7ba2c347-1c17-455c-b844-e92da8b10bd6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		pin_flag
		 (.oe(tmpOE__pin_flag_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__pin_flag_net[0:0]}),
		  .io({tmpIO_0__pin_flag_net[0:0]}),
		  .siovref(tmpSIOVREF__pin_flag_net),
		  .interrupt({tmpINTERRUPT_0__pin_flag_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pin_flag_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge Net_6614)
    begin
        cy_tff_1 <= Net_383^Net_379;
    end
    assign Net_379 = cy_tff_1;
    // -- TFF End --
