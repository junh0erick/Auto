...
{
    uint8 staticBits = (u_DR & (uint8)(~u_MASK));
    u_DR = staticBits | ((uint8)(value << u_SHIFT) & u_MASK);
}
...
{
	CyPins_SetPinDriveMode(u_0, mode);
}
...
{
    return (u_DR & u_MASK) >> u_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(u_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & u_0_INTR) != 0u) 
		{ 
			 u_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (u_INTSTAT & u_MASK) >> u_SHIFT;
    }
