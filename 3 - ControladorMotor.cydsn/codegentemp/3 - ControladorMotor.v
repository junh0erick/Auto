// ======================================================================
// 3 - ControladorMotor.v generated from TopDesign.cysch
// 03/30/2026 at 17:21
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=1600, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONFIG_TITLE=VDAC8_u, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC8_u, CY_INSTANCE_SHORT_NAME=VDAC8_u, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=VDAC8_u, )
...
module top ;
    ...
    VDAC8_v1_90_7 VDAC8_u (
        .data(8'b00000000),
        .strobe(1'b0),
        .vOut(Net_373));
    defparam VDAC8_u.Data_Source = 0;
    defparam VDAC8_u.Initial_Value = 100;
    defparam VDAC8_u.Strobe_Mode = 0;

	wire [0:0] tmpOE__esfuerzo_net;
	wire [0:0] tmpFB_0__esfuerzo_net;
	wire [0:0] tmpIO_0__esfuerzo_net;
	wire [0:0] tmpINTERRUPT_0__esfuerzo_net;
	electrical [0:0] tmpSIOVREF__esfuerzo_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		esfuerzo
		 (.oe(tmpOE__esfuerzo_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__esfuerzo_net[0:0]}),
		  .analog({Net_373}),
		  .io({tmpIO_0__esfuerzo_net[0:0]}),
		  .siovref(tmpSIOVREF__esfuerzo_net),
		  .interrupt({tmpINTERRUPT_0__esfuerzo_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__esfuerzo_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
