...
%\insertarfigura{img/Estados/respuesta_LQI.png}{Respuesta temporal con LQI.}{fig:resp_LQI}{1}

%\insertarfigura{img/Estados/esfuerzo_LQI.png}{Esfuerzo de control con LQI.}{fig:esfuerzo_LQI}{1}
