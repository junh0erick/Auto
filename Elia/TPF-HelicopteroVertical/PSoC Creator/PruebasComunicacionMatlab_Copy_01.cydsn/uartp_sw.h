...
#define UARTP_CMD_PERIOD ((uint8)'p')
...
extern volatile uint8 UARTP_N;
extern volatile uint8 UARTP_Ncnt;
extern volatile uint8 UARTP_FlagSendU;
extern volatile uint8 UARTP_FlagSendY;
